...
Наследник всех своих родных.
    ...
    fun longestIncreasingSubSequence(longestIncreasingSubSequence: (List<Int>) -> List<Int>) {
        ...
        assertEquals(listOf(0, 1, 2), longestIncreasingSubSequence(listOf(3, 4, 0, 1, 2)))
        assertEquals(listOf(3, 4), longestIncreasingSubSequence(listOf(3, 4, 0, 1)))
    }
    ...
    fun shortestPathOnField(shortestPathOnField: (String) -> Int) {
        ...
        assertEquals(1, shortestPathOnField("input/field_in4.txt"))
        assertEquals(28, shortestPathOnField("input/field_in5.txt"))
        assertEquals(18, shortestPathOnField("input/field_in6.txt"))
    }
